...
public class HomeController {
    ...
    @GetMapping("/filtrar")
    public String filtrarEventos(@RequestParam(name = "fecha", required = false) LocalDate fecha, @RequestParam(name="idDispositivo", required = false) Integer idDispositivo, Model model) {
