...
public class EstacionamientoController {
	...
	@PostMapping("/create")
	public RedirectView create(@ModelAttribute("estacionamiento") Estacionamiento estacionamiento,@RequestParam("edificioId") int edificioId) {
	...
	/*
	 * @GetMapping("/delete/{id}") public ModelAndView delete(@PathVariable("id")
	 * int id) { ModelAndView mV = new ModelAndView();
	 * mV.setViewName(ViewRouteHelper.REPORTES_ESTACIONAMIENTOS);
	 * dispositivoService.remove(id); return mV; }
	 */
}
